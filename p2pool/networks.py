...
nets = dict(
    ...
    feathercoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9357,
        BOOTSTRAP_ADDRS='P2Pool.org:19327 i.hashfaster.com:19327 p2poolmining.org ftc.p2pool.skralg.com:19327'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
